...
function createItinerary() {
  ...
  savedItineraries.push({
    ...
    metroLines: getCurrentlyVisibleMetroLines()
  });
...
function deleteItinerary(id) {
  ...
  const confirmDelete = confirm(`Supprimer l’itinéraire "${itinerary.name}" ?`);
